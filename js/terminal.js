...
class Terminal {
    ...
    async input(text, testMode=false) {
        ...
        if (commandText + ' ' + args[0] == "GO HOME") {
            ...
            terminal.print(" ____                 _       __            __           __\n")
            terminal.print("|  _ \\ __ _ _ __ __ _| |__   /_/ _ __  ___  \\ \\   ___   / /\n")
            terminal.print("| |_) / _` | '__/ _` | '_ \\ / _ \\ '_ \\/ __|  \\ \\ / _ \\ / / \n")
            terminal.print("|  __/ (_| | | | (_| | |_) |  __/ | | \\__ \\   \\ \\ (_) / /  \n")
            terminal.print("|_|   \\__,_|_|  \\__,_|_.__/ \\___|_| |_|___/    \\_\\___/_/   \n")
        } else {
            if (this.commandExists(commandText)) {
                ...
                return await command.run(tokens, rawArgs, {callFinishFunc: !testMode, terminalObj: this})
                 ...
                 // if ([].contains(name)) {
                //     throw new Info(`nahasdhuahds`)
                //     if (nome == "breakeven") {
                //         terminal.printLink("PARABÉEEEENS!! tamtam")
                //     } else {
